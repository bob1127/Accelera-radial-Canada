...
export function GridTileImage({
  ...
  return (
    <div
      className={clsx(
        "group relative flex w-full items-center flex-col justify-center overflow-hidden h-full rounded-lg bg-white transition-all",
        {
    ...
    >
      {props.src ? (
        <Image
          className={clsx("!w-[100%] mx-auto h-[80px]", {
